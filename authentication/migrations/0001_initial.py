# Generated by Django 4.2.1 on 2023-05-27 11:15
...
#         if count == 0:
#             cursor.execute(f"ALTER TABLE {user._meta.db_table} AUTO_INCREMENT = 1;")
            
# def update_user_data(apps, schema_editor):
#     User = apps.get_model('authentication', 'User')
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # migrations.RunPython(update_user_data),
